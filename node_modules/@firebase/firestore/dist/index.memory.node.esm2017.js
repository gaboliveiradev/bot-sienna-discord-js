...
class Firestore extends Compat {
    ...
    runTransaction(updateFunction) {
        ...
        return firestoreClientTransaction(client, (transaction) => {
...
class Transaction$1 {
    ...
    get(documentRef) {
        ...
        return this._transaction
            ...
            const doc = docs[0];
            if (doc instanceof NoDocument) {
                return new DocumentSnapshot$2(this._firestore, new DocumentSnapshot$1(this._firestore._delegate, userDataWriter, ref._key, null, new SnapshotMetadata(
                /*hasPendingWrites= */ false, 
                /* fromCache= */ false), ref._converter));
            }
            else if (doc instanceof Document) {
                return new DocumentSnapshot$2(this._firestore, new DocumentSnapshot$1(this._firestore._delegate, userDataWriter, ref._key, doc, new SnapshotMetadata(
                /*hasPendingWrites= */ false, 
                /* fromCache= */ false), ref._converter));
            }
            else {
    ...
    update(documentRef, fieldOrUpdateData, value, ...moreFieldsAndValues) {
        const ref = validateReference('Transaction.update', documentRef, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        if (fieldOrUpdateData instanceof Compat) {
            fieldOrUpdateData = fieldOrUpdateData._delegate;
...
class WriteBatch {
    ...
    update(documentRef, fieldOrUpdateData, value, ...moreFieldsAndValues) {
        this.verifyNotCommitted();
        const ref = validateReference('WriteBatch.update', documentRef, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        if (fieldOrUpdateData instanceof Compat) {
            fieldOrUpdateData = fieldOrUpdateData._delegate;
...
class Query$1 {
    ...
    where(field, opStr, value) {
        const fieldPath = fieldPathFromArgument$1('Query.where', field);
        const filter = newQueryFilter(this._query, 'Query.where', this._userDataReader, this.firestore._databaseId, fieldPath, opStr, value);
    ...
    orderBy(field, directionStr) {
        ...
        const fieldPath = fieldPathFromArgument$1('Query.orderBy', field);
    ...
    onSnapshot(...args) {
        ...
        const observer = {
            next: snapshot => {
                if (args[currArg]) {
                    args[currArg](new QuerySnapshot$1(this.firestore, new QuerySnapshot(this.firestore._delegate, this._userDataWriter, new Query(this.firestore._delegate, this._converter, this._query), snapshot)));
                }
            },
            error: args[currArg + 1],
            complete: args[currArg + 2]
    ...
    get(options) {
        ...
        return (options && options.source === 'cache'
            ...
            : firestoreClientGetDocumentsViaSnapshotListener(client, this._query, options)).then(snap => new QuerySnapshot$1(this.firestore, new QuerySnapshot(this.firestore._delegate, this._userDataWriter, new Query(this.firestore._delegate, this._converter, this._query), snap)));
    }
}
...
function validateReference(methodName, documentRef, firestore) {
    const reference = cast(documentRef, DocumentReference);
