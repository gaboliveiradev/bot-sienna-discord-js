...
var Firestore = /** @class */ (function (_super) {
    ...
    Firestore.prototype.collection = function (pathString) {
        ...
        return new CollectionReference$1(ResourcePath.fromString(pathString), this, 
        /* converter= */ null);
    };
    Firestore.prototype.doc = function (pathString) {
        validateNonEmptyArgument('Firestore.doc', 'path', pathString);
        ensureFirestoreConfigured(this._delegate);
        return DocumentReference$1.forPath(ResourcePath.fromString(pathString), this, 
        /* converter= */ null);
    };
    Firestore.prototype.collectionGroup = function (collectionId) {
        validateNonEmptyArgument('Firestore.collectionGroup', 'collectionId', collectionId);
        if (collectionId.indexOf('/') >= 0) {
            throw new FirestoreError(Code.INVALID_ARGUMENT, "Invalid collection ID '" + collectionId + "' passed to function " +
                "Firestore.collectionGroup(). Collection IDs must not contain '/'.");
        }
        ensureFirestoreConfigured(this._delegate);
        return new Query$1(newQueryForCollectionGroup(collectionId), this, 
        /* converter= */ null);
    };
    Firestore.prototype.runTransaction = function (updateFunction) {
        var _this = this;
        var client = ensureFirestoreConfigured(this._delegate);
        return firestoreClientTransaction(client, function (transaction) {
...
var Transaction$1 = /** @class */ (function () {
    ...
    Transaction$1.prototype.get = function (documentRef) {
        ...
        var userDataWriter = new UserDataWriter(this._firestore);
        return this._transaction
            ...
            var doc = docs[0];
            if (doc instanceof NoDocument) {
                return new DocumentSnapshot$2(_this._firestore, new DocumentSnapshot$1(_this._firestore._delegate, userDataWriter, ref._key, null, new SnapshotMetadata(
                /*hasPendingWrites= */ false, 
                /* fromCache= */ false), ref._converter));
            }
            else if (doc instanceof Document) {
                return new DocumentSnapshot$2(_this._firestore, new DocumentSnapshot$1(_this._firestore._delegate, userDataWriter, ref._key, doc, new SnapshotMetadata(
                /*hasPendingWrites= */ false, 
                /* fromCache= */ false), ref._converter));
            }
            else {
    ...
    Transaction$1.prototype.update = function (documentRef, fieldOrUpdateData, value) {
        ...
        var ref = validateReference('Transaction.update', documentRef, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        if (fieldOrUpdateData instanceof Compat) {
            fieldOrUpdateData = fieldOrUpdateData._delegate;
...
var WriteBatch = /** @class */ (function () {
    ...
    WriteBatch.prototype.update = function (documentRef, fieldOrUpdateData, value) {
        ...
        this.verifyNotCommitted();
        var ref = validateReference('WriteBatch.update', documentRef, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        if (fieldOrUpdateData instanceof Compat) {
            fieldOrUpdateData = fieldOrUpdateData._delegate;
    ...
    WriteBatch.prototype.commit = function () {
        ...
        if (this._mutations.length > 0) {
            var client = ensureFirestoreConfigured(this._firestore._delegate);
...
var DocumentReference$1 = /** @class */ (function (_super) {
    ...
    Object.defineProperty(DocumentReference$1.prototype, "parent", {
        get: function () {
            return new CollectionReference$1(this._delegate._path.popLast(), this.firestore, this._delegate._converter);
        },
        enumerable: false,
        configurable: true
    });
    ...
    DocumentReference$1.prototype.collection = function (pathString) {
        validateNonEmptyArgument('DocumentReference.collection', 'path', pathString);
        if (!pathString) {
        ...
        return new CollectionReference$1(this._delegate._path.child(path), this.firestore, 
        /* converter= */ null);
    };
 ...
 */
function replaceFunctionName(e, originalFunctionName, updatedFunctionName) {
    e.message = e.message.replace(originalFunctionName + "()", updatedFunctionName + "()");
    return e;
}
/**
...
var Query$1 = /** @class */ (function () {
    ...
    Query$1.prototype.where = function (field, opStr, value) {
        var fieldPath = fieldPathFromArgument$1('Query.where', field);
        var filter = newQueryFilter(this._query, 'Query.where', this._userDataReader, this.firestore._databaseId, fieldPath, opStr, value);
        return new Query$1(queryWithAddedFilter(this._query, filter), this.firestore, this._converter);
    };
    Query$1.prototype.orderBy = function (field, directionStr) {
        ...
        var fieldPath = fieldPathFromArgument$1('Query.orderBy', field);
        var orderBy = newQueryOrderBy(this._query, fieldPath, direction);
        return new Query$1(queryWithAddedOrderBy(this._query, orderBy), this.firestore, this._converter);
    };
    Query$1.prototype.limit = function (n) {
        validatePositiveNumber('Query.limit', n);
        return new Query$1(queryWithLimit(this._query, n, "F" /* First */), this.firestore, this._converter);
    };
    Query$1.prototype.limitToLast = function (n) {
        validatePositiveNumber('Query.limitToLast', n);
        return new Query$1(queryWithLimit(this._query, n, "L" /* Last */), this.firestore, this._converter);
    };
    Query$1.prototype.startAt = function (docOrField) {
        ...
        /*before=*/ true);
        return new Query$1(queryWithStartAt(this._query, bound), this.firestore, this._converter);
    };
    ...
    Query$1.prototype.endBefore = function (docOrField) {
        ...
        /*before=*/ true);
        return new Query$1(queryWithEndAt(this._query, bound), this.firestore, this._converter);
    };
    ...
    Query$1.prototype.boundFromDocOrFields = function (methodName, docOrField, fields, before) {
        if (docOrField instanceof DocumentSnapshot$2) {
            return newQueryBoundFromDocument(this._query, this.firestore._databaseId, methodName, docOrField._delegate._document, before);
        }
        else {
            var allFields = [docOrField].concat(fields);
            return newQueryBoundFromFields(this._query, this.firestore._databaseId, this._userDataReader, methodName, allFields, before);
        }
    };
    Query$1.prototype.onSnapshot = function () {
        ...
        var observer = {
            next: function (snapshot) {
                if (args[currArg]) {
                    args[currArg](new QuerySnapshot$1(_this.firestore, new QuerySnapshot(_this.firestore._delegate, _this._userDataWriter, new Query(_this.firestore._delegate, _this._converter, _this._query), snapshot)));
                }
            },
            error: args[currArg + 1],
            complete: args[currArg + 2]
        ...
        var client = ensureFirestoreConfigured(this.firestore._delegate);
    ...
    Query$1.prototype.get = function (options) {
        ...
        return (options && options.source === 'cache'
            ...
            : firestoreClientGetDocumentsViaSnapshotListener(client, this._query, options)).then(function (snap) { return new QuerySnapshot$1(_this.firestore, new QuerySnapshot(_this.firestore._delegate, _this._userDataWriter, new Query(_this.firestore._delegate, _this._converter, _this._query), snap)); });
    };
    return Query$1;
}());
...
var QuerySnapshot$1 = /** @class */ (function (_super) {
    ...
    Object.defineProperty(QuerySnapshot$1.prototype, "query", {
        get: function () {
            return new Query$1(this._delegate.query._query, this._firestore, this._delegate.query._converter);
        },
        enumerable: false,
        configurable: true
    });
...
var CollectionReference$1 = /** @class */ (function (_super) {
    ...
    function CollectionReference$1(_path, firestore, _converter) {
    ...
    Object.defineProperty(CollectionReference$1.prototype, "parent", {
        get: function () {
            ...
            if (parentPath.isEmpty()) {
                ...
                return DocumentReference$1.forPath(parentPath, this.firestore, 
                /* converter= */ null);
            }
        },
        enumerable: false,
    ...
    CollectionReference$1.prototype.doc = function (pathString) {
        ...
        var path = ResourcePath.fromString(pathString);
        return DocumentReference$1.forPath(this._query.path.child(path), this.firestore, this._converter);
    };
    CollectionReference$1.prototype.add = function (value) {
        ...
        return DocumentReference$1.forKey(docRef._delegate._key, this.firestore, null)
            .set(convertedValue)
            .then(function () { return docRef; });
    };
    CollectionReference$1.prototype.withConverter = function (converter) {
        return new CollectionReference$1(this._path, this.firestore, converter);
    };
    return CollectionReference$1;
}(Query$1));
function validateReference(methodName, documentRef, firestore) {
    var reference = cast(documentRef, DocumentReference);
