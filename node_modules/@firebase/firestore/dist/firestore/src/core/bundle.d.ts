 ...
 * loading a bundle.
 */
export declare function bundleInitialProgress(metadata: BundleMetadata): ApiLoadBundleTaskProgress;
/**
 * Returns a `LoadBundleTaskProgress` representing the progress that the loading
 * has succeeded.
 */
export declare function bundleSuccessProgress(metadata: BundleMetadata): ApiLoadBundleTaskProgress;
